...
- **Segment:** interstate authorised-for-hire property carriers, 1–5 power units, Class 7–8, general freight (dry van / reefer / flatbed and similar). Private carriers and intrastate-only are declined (D12) — they need different data and different pricing.
