...
> **The tables in the four sections below are superseded.** They predate the credibility off-balance correction and the experience-scaled minimum premium applied on 2026-09-10 (DELIVERABLES G25, G27), which raised every non-floor profile by 4–6%. They are kept because the *before/after* columns are the record of why each calibration change was made. **The current comparison is the last section, § After the credibility and floor corrections**, and `data/derived/market_benchmark.csv` is regenerated by `python samples/make_benchmark_samples.py --run`.
...
## After the credibility and floor corrections (2026-09-10) — **current**

`config/rates.yaml`: `credibility.offbalance_correction` on, `loadings.minimum_premium_experience_scaled` on
(DELIVERABLES G27, G25; RATIONALE A14, A15). The off-balance divisor removes a systematic ~4% discount that the
3× own-rate cap had been leaking, so **every profile whose technical premium sits above the floor rises**. Floor-bound
profiles (P2, P6, P9) do not move, because their experience relativity is a discount and the floor is never scaled by
a discount. Figures from `data/derived/market_benchmark.csv`, run 2026-09-10.

| # | Per unit before | Per unit now | Change | Floor binds? | Rel. product | Observed liab. est. | Gap vs liab. est. | Gap vs published |
|---|---|---|---|---|---|---|---|---|
| P1 | $10,407 | **$11,012** | +5.8% | no | 1.513 | $7,800 | +41% | −1% |
| P2 | $8,000 | **$8,000** | — | yes | 0.819 | $6,200 | +29% | −9% |
| P3 | $14,059 | **$14,877** | +5.8% | no | 2.043 | $12,000 | +24% | −1% |
| P4 | $9,943 | **$10,521** | +5.8% | no | 1.445 | $12,500 | −16% | −16% |
| P5 | $12,809 | **$13,553** | +5.8% | no | 1.862 | $14,000 | −3% | −3% |
| P6 | $8,000 | **$8,000** | — | yes | 0.756 | $11,250 | −29% | −29% |
| P7 | $14,027 | **$14,842** | +5.8% | no | 2.039 | $12,500 | +19% | +2% |
| P8 | $18,964 | **$19,731** | +4.0% | no | 2.710 | $18,137 | +9% | +9% |
| P9 | $8,000 | **$8,000** | — | yes | 0.884 | $8,600 | −7% | −7% |
| P10 | $9,446 | **$10,008** | +6.0% | no | 1.375 | $11,500 | −13% | −31% |

| Statistic | Before (trend cut) | **Now** |
|---|---|---|
| Median gap vs liability estimate | −1.2% | **+2.8%** |
| Mean gap vs liability estimate | +1.4% | **+5.4%** |
| Range | −29% to +33% | **−29% to +41%** |
| Within ±20% of liability estimate | 6 of 10 | **6 of 10** |
| Within ±20% of published figure | 7 of 10 | **8 of 10** |
| Median gap vs published figure | — | **−5.1%** |

Notes on the movement:

- **The uplift is 5.8% at one power unit and 4.0% at five.** The off-balance divisor depends on fleet size, and P8
  already carried an own-experience surcharge (one crash on 10 unit-years), so less of its relativity was leaking.
- **We now sit slightly dearer than the market on the liability-only estimates and slightly cheaper than the published
  figures.** That is the expected place to be: the liability-only estimates are mine, and they strip out physical
  damage and cargo from bundled numbers.
- **P1 and P2 remain the two largest overshoots at +41% and +29%, and both still depend on the 70% liability share
  assumed of Progressive's bundled premium.** Against the published figures they are −1% and −9%. That one assumption
  moves the P1/P2 conclusion more than any factor in the config, so they were not tuned further.
- **P6 is still the honest miss** at −29%: a five-year, late-model, Indiana, intermediate-radius owner-operator at the
  $8,000 floor against a published $7,500–$15,000 range. A higher floor would fix P6 and break P2 and P9.
- **Book impact:** real-carrier written premium $542k → **$578.6k** (+6.7%), floor binds on 5 of 34 written (was 4).
  The decline rate did not move on any set — this change alters what a surcharged risk *pays*, not the appetite.
